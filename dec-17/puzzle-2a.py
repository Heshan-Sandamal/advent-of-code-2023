...
def get_neighbours(heat_loss, row, column, direction, consecutive_count):
    ...
    # Go straight if consecutive count is less than 10
    ...
    # cam turn left/right after consecutive movement count of 4 in same direction
...
while priority_queue:
    ...
    if cell[0] == len(grid) - 1 and cell[1] == len(grid[0]) - 1 and steps >= 4:
        print(heat_loss)
        break
